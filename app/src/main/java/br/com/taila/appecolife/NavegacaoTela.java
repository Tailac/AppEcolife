...
public class NavegacaoTela extends AppCompatActivity {
    ...
    public void abrePontuacaoRecebida(String pontuacao){
        Intent intentPontuacao = new Intent(this,PontuacaoRecebidaActivity.class);
    ...
    public void abrePontuacao( ){
        Intent intentAbrirPontuacao = new Intent(this, PontuacaoActivity.class);
        startActivity(intentAbrirPontuacao);
        finish();
    }
